...
public class bluetoothConexion extends AppCompatActivity {
    ...
    // BroadcastReceiver para detectar la desconexión de dispositivos Bluetooth
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IdDisEncontrados = findViewById(R.id.IdDispEncontrados);
        ...
        // Registrar el BroadcastReceiver para escuchar la desconexión del dispositivo
        registerReceiver(bluetoothDisconnectReceiver, new IntentFilter("android.bluetooth.device.action.ACL_DISCONNECTED"));
        ...
        IdBtnLuz2on.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // CODIGO A EJECUTAR DE ESTE EVENTO PARA ESTE BOTON
            }
        ...
        IdBtnLuz2off.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // CODIGO A EJECUTAR DE ESTE EVENTO PARA ESTE BOTON
            }
    ...
    protected void onDestroy() {
        super.onDestroy();
        // Desregistrar el BroadcastReceiver cuando se destruye la actividad
    ...
    ActivityResultLauncher<Intent> someActivityResultLauncher = registerForActivityResult(
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == bluetoothConexion.REQUEST_ENABLE_BT) {
